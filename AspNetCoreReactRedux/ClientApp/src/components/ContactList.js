...
class ContactList extends Component {
    ...
    save() {
        ...
        this.dialogHide();
        this.growl.show({ severity: 'success', detail: this.newContact ? "Record saved successfully" : "Registration changed successfully" });
    }

    delete() {
        this.props.deleteContact(this.state.contact.contactId);
        this.dialogHide();
        this.growl.show({ severity: 'error', detail: "Record deleted successfully" });
    }
    ...
    render() {
        ...
        let footer = <div className="p-clearfix" style={{ width: '100%' }}>
            <Button style={{ float: 'left' }} label="Add Contact" onClick={this.addNew} />
        ...
        let dialogFooter = <div className="ui-dialog-buttonpane p-clearfix">
            ...
            <Button label={this.newContact ? "Save" : "Change"} icon="pi pi-check" onClick={this.save} tooltip="Click to save"/>
        </div>;
        ...
        return (
            <div>
                ...
                <Dialog visible={this.state.displayDialog} style={{ 'width': '380px' }} header={this.newContact ? "Create Contact" : "Change Contact"} modal={true} footer={dialogFooter} onHide={() => this.setState({ displayDialog: false })}>
                    {
                        this.state.contact &&
